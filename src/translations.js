export const translations = {
  vi: {
    ...
    skills: {
      ...
      soft: "Kỹ năng bổ trợ",
      items: {
        ja: "Tiếng Nhật (JLPT N2)",
        en: "Tiếng Anh (Giao tiếp thương mại)",
    ...
    contact: {
      ...
      phone: "Số điện thoại",
      address: "Khu vực",
      address_value: "TP. Hồ Chí Minh, Việt Nam",
      copyright_reserved: "Bảo lưu mọi quyền.",
      copyright_by: "Thiết kế bởi",
      form: {
        name_label: "Họ & Tên",
        ...
        message_placeholder: "Nhập nội dung lời nhắn...",
        send_btn: "Gửi tin nhắn",
        success_msg: "Cảm ơn bạn! Tin nhắn của bạn đã được gửi thành công. Tôi sẽ phản hồi sớm nhất có thể."
      }
    }
  },
  en: {
    ...
    contact: {
      ...
      phone: "Phone Number",
      address: "Location",
      address_value: "Ho Chi Minh City, Vietnam",
      copyright_reserved: "All Rights Reserved.",
      copyright_by: "Website by",
      form: {
        ...
        success_msg: "Thank you! Your message has been sent successfully. I will get back to you as soon as possible."
      }
    }
  },
  ja: {
      ...
      items: [
        {
          ...
          title: "ホアセン大学",
          sub: "日本学科（学士）",
          desc: "ビジネス日本語を専攻。プロフェッショナルな翻訳と企業間コミュニケーションスキルを習得。"
        },
        {
          year: "2024年",
    ...
    contact: {
      title: "お問い合わせ",
      greeting: "貴社およびパートナーの皆様と協力できることを楽しみにしております。",
      closing: "よろしくお願いいたします",
      email: "メールアドレス",
      phone: "電話番号",
      address: "希望勤務地",
      address_value: "ベトナム ホーチミン市",
      copyright_reserved: "All Rights Reserved.",
      copyright_by: "制作:",
      form: {
        name_label: "お名前",
        ...
        message_label: "メッセージ",
        message_placeholder: "メッセージ内容を入力してください...",
        send_btn: "送信する",
        success_msg: "お問い合わせありがとうございます。メッセージは正常に送信されました。追ってご連絡いたします。"
      }
    }
  }
};
